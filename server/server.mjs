...
import { importWalletAndSendXLM, getBalanceWallet, createNewWallet } from './wallet.mjs';
...
app.post('/import-wallet', async (req, res) => {
  ...
  try {
    const result = await importWalletAndSendXLM(privateKey, recipientAddress, amount);
