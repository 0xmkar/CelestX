...
MONGO_URI = "mongodb+srv://stev3rajhacker:shivrajtestpass@test-cluster.l2zx0.mongodb.net/?retryWrites=true&w=majority&appName=test-cluster"
DB_NAME = "test"
...
def analyze_text():
    ...
    system_prompt = {
        ...
        - the currency should be in having their token symbol name in all small for example Bitcoin = btc , ethereum = eth , sonic = S , electroneum = ETN , XLM = XLM, base = ETH
    ...
    try:
        ...
        receiver_twitter_id = finalresponse[3]  # Extract the receiver's Twitter ID
